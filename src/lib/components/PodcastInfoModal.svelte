...
<dialog id={modalId} class="modal" inert>
	<div class="modal-box flex max-w-2xl flex-col overflow-hidden p-0">
		<TouchableButton
			onClick={() => close()}
			ariaLabel="Close"
			circle={false}
		...
		<div class="flex max-h-[75vh] flex-col gap-4 overflow-hidden p-4 sm:flex-row sm:gap-6 sm:p-6">
