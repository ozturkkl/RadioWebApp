...
A configurable radio and podcast player for live streams and RSS archives shipped as a PWA on the web. 
Packaged and released as a TWA in IOS AppStore, and Android Google Play Store.
